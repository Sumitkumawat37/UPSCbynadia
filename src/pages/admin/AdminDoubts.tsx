...
const AdminDoubts = () => {
  ...
  const handleReply = (doubtId: string) => {
    ...
    toast.success("Reply sent — demo only");
    setReplyText("");
    setReplyingTo(null);
  };
                ...
                {replyingTo === d.id ? (
                  <div className="space-y-2">
                    ...
                    <div className="flex gap-2">
                      <Button size="sm" className="flex-1" onClick={() => handleReply(d.id)}>
                  ...
                  <Button size="sm" variant="secondary" className="w-full" onClick={() => setReplyingTo(d.id)}>
              ...
              <Card key={d.id} className="p-4">
                <div className="flex items-start gap-2 mb-2">
                  ...
                  <div className="flex-1">
                    <span className="text-sm font-medium">{d.studentName}</span>
                    <Badge className="bg-success/10 text-success border-0 text-[10px] ml-2">Answered</Badge>
                  </div>
                </div>
